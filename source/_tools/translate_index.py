"""Apply Chinese translations for the top-level book index (source/index.md).

Run with: poetry run python source/_tools/translate_index.py
...
PO_PATH = "source/locale/zh_CN/LC_MESSAGES/index.po"
