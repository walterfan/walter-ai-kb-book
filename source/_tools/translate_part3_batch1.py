...
Run with: poetry run python source/_tools/translate_part3_batch1.py

Style guide inherited from source/_tools/translations/ch02-ir-rag-primer.zh.py:
...
LOCALE_ROOT = "source/locale/zh_CN/LC_MESSAGES/part3-code-layer"
